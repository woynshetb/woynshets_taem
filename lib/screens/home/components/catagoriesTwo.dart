...
class ProductCatagoryPageTwo extends StatefulWidget {
  @override
  State<ProductCatagoryPageTwo> createState() => _ProductCatagoryPageTwoState();
}

class _ProductCatagoryPageTwoState extends State<ProductCatagoryPageTwo> {
  @override
  void initState() {
    super.initState();
    this.fetchProduct();
  ...
  fetchProduct() async {
    final response = await http.get(
        Uri.parse('https://woynshetstaem.herokuapp.com/product/processed'));
