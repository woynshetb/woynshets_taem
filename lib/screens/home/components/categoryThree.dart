...
class ProductCatagoryPageThree extends StatefulWidget {
  @override
  State<ProductCatagoryPageThree> createState() =>
      _ProductCatagoryPageThreeState();
}

class _ProductCatagoryPageThreeState extends State<ProductCatagoryPageThree> {
  @override
  void initState() {
    super.initState();
    this.fetchProduct();
  ...
  fetchProduct() async {
    final response = await http
        .get(Uri.parse('https://woynshetstaem.herokuapp.com/product/wots'));
